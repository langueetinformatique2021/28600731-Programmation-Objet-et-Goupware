...
public class Devoir1_TD4_28600731 {
		...
		public static void main(String[] args) {
			 ...
			 * trier la liste des variables dans l'ordre croissant et compte le nombre de variables, ici avec Arrays.sort et on range avec "int []...
			 ...
			 * problème rencontré pour convertir un double vers un int, donc changer p6 en double
			 */
